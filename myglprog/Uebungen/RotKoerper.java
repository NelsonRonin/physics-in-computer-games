package Uebungen;//  -------------   Rotations-Koerper  (Kugel, Torus, Zylinder)  ------------
...
{
   //  --------------  globale Daten  -----------------
   MyGLBase1 mygl;                                 // OpenGL Kontext fuer PPP


   //  ------------------  Methoden  ------------------

   public RotKoerper(MyGLBase1 mygl)
   {  this.mygl = mygl;
   }
