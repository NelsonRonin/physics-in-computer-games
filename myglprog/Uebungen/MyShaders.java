package Uebungen;//  ------------  Vertex- und Fragment-Shaders  -----------------------------------------
...
public class MyShaders
{
    ...
    public static String getProgramInfoLog(GL3 gl, int obj)               // Info- and Error-Messages
    {
       ...
       gl.glGetProgramiv(obj, GL3.GL_INFO_LOG_LENGTH, params, 0);         // get log-hantelLeng
       int logLen = params[0];
       if (logLen <= 0)
         return "";
    ...
    {  int params[] = new int[1];
       gl.glGetShaderiv(obj, GL3.GL_INFO_LOG_LENGTH, params, 0);         // get log-hantelLeng
       int logLen = params[0];
       if (logLen <= 0)
         return "";
       // Get the log
